...
def test_check_record_accepts_a_negative_amount():
    """Sign is not a contract concern: apply_fees() owns the credit rule."""
    assert check_record({**CLEAN, "amount": -1})["amount"] == -1
